class Enum(object):
    ...
    def to_choices(self):
        value_label_tuples = [self._DATA_MAPPING[key]
    ...
    def to_dict(self):
        ...
        for key in self._DATA_MAPPING:
            value_label_dict[
                self._DATA_MAPPING[key][0]] = self._DATA_MAPPING[key][1]
    ...
    def get_value(self, label):
        for key in self._DATA_MAPPING:
            if self._DATA_MAPPING[key][1] == label:
                return self._DATA_MAPPING[key][0]
